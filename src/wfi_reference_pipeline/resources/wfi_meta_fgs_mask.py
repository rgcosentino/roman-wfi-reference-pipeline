...
@dataclass
class WFIMetaFGSMask(WFIMetadata):
    """
    Class WFIMetaFGSMask() Metadata Specific to FGS_MASK Reference File Type
    ...
    def __post_init__(self):
        super().__post_init__()
        self.reference_type = constants.REF_TYPE_FGS_MASK
        self.mode = constants.WFI_MODE_WIM
