...
WFI_PEDIGREE = {"GROUND", "MODEL", "DUMMY", "SIMULATION", "INFLIGHT"}
...
DEFAULT_DESCRIPTION_SENTINEL = "PLACEHOLDER_DESCRIPTION_DO_NOT_DELIVER"
DEFAULT_DESCRIPTION = DEFAULT_DESCRIPTION_SENTINEL + " — {ref_type_name}"
